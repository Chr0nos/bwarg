...
# Generated by qmake (2.01a) (Qt 4.8.4) on: mar. juil. 16 20:58:27 2013
# Project:  Bwarg.pro
# Template: app
...
install_bwarg: first FORCE
	...
	-$(INSTALL_PROGRAM) /home/adamaru/projets/bwarg/Bwarg/bwarg $(INSTALL_ROOT)/usr/bin/
	-strip $(INSTALL_ROOT)/usr/bin/bwarg


uninstall_bwarg:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/bin/bwarg
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/bin/ 


install_trad: first FORCE
	@$(CHK_DIR_EXISTS) $(INSTALL_ROOT)/usr/share/bwarg/ || $(MKDIR) $(INSTALL_ROOT)/usr/share/bwarg/ 
	-$(INSTALL_FILE) /home/adamaru/projets/bwarg/Bwarg/lang_fr.qm $(INSTALL_ROOT)/usr/share/bwarg/
	-$(INSTALL_FILE) /home/adamaru/projets/bwarg/Bwarg/lang_us.qm $(INSTALL_ROOT)/usr/share/bwarg/


uninstall_trad:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/bwarg/lang_fr.qm 
	 -$(DEL_FILE) -r $(INSTALL_ROOT)/usr/share/bwarg/lang_us.qm
	-$(DEL_DIR) $(INSTALL_ROOT)/usr/share/bwarg/ 


install:  install_bwarg install_trad  FORCE

uninstall: uninstall_bwarg uninstall_trad   FORCE
